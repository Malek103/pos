...
class SupplierController extends Controller
{
    ...
    {
        $clients = Client::where('type', 'supplier')->where('user_id', Auth::id())->paginate(5);
    ...
    public function show($id, Request $request)
    {
        ...
        return view('reports.supplier.show', [
            'client' => $client,
            'h_receipts' => $client->hreceipts->where('status', 'notdeleted')->where('created_at', '>=', $request->startDate)->where('created_at', '<=',  $request->endDate),
    ...
    public function search(Request $request)
    {
        ...
        $clients = Client::where('type', 'supplier')
