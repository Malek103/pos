    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/welcame') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">welcame</a>
                @else
...
<head>
    ...
    <title>Page 2</title>
    <link rel="stylesheet" href="{{ asset('welcame/nicepage.css') }}" media="screen">
    <link rel="stylesheet" href="{{ asset('welcame/Page-2.css') }}" media="screen">
    <script class="u-script" type="text/javascript" src="{{ asset('welcame/jquery.js') }}" defer=""></script>
    <script class="u-script" type="text/javascript" src="{{ asset('welcame/nicepage.js') }}" defer=""></script>
...
<body class="u-body u-xl-mode">
    <header class="u-clearfix u-header u-header" id="sec-a650">
        <div class="u-clearfix u-sheet u-sheet-1">
            <a href="https://nicepage.com" class="u-image u-logo u-image-1" data-image-width="296"
                data-image-height="171">
                <img src="{{ asset('welcame/images/poslogo.jfif') }}" class="u-logo-image u-logo-image-1">
            </a>
    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="carousel_f28c" data-image-width="1920"
        ...
        <div class="u-clearfix u-sheet u-sheet-1">
            <div class="u-align-center u-border-6 u-border-white u-container-style u-expanded-width-xs u-group u-opacity u-opacity-15 u-group-1"
                ...
                <div class="u-container-layout u-container-layout-1">
                    <h1 class="u-custom-font u-font-playfair-display u-text u-title u-text-1"><b>Point Of Sale</b>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-e932">
